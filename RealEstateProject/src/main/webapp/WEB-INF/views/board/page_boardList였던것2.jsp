        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="page_board_choose.do">게시판</a></li>
...
<main>
    ...
    <!-- <div class="container-xxl" style="width: 100%"> -->
        <div class="row justify-content-center p-5 " >
            ...
            <div class="col-lg-12 col-12 text-center" style="width: 80%">
            	<!-- justify-content-[ between, center, start, end] -->
                <!-- <h3 class="mb-4">
                	글목록
                </h3> -->
            
                <div class="custom-block bg-white shadow-lg px-5 ">
                    <!-- 글 갯수 -->
                    <span class="badge bg-finance rounded-pill ms-auto">30</span>
                    <table class="table pl-10 pr-10">
					    <thead>
					        <tr>
					            <th scope="col">#</th> <!-- 글번호 -->
